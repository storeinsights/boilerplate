...
class HttpProxy extends Proxy {
    ...
    prepare_options() {
        ...
        if(this.retry){
            Object.assign(optionsData,{retry: this.retry});
            if(this.delay) Object.assign(optionsData,{delay: this.delay});
            if(this.factor) Object.assign(optionsData,{factor: this.factor});
            if(this.accepted) Object.assign(optionsData,{accepted: this.accepted});
        }
        return optionsData;
    }
